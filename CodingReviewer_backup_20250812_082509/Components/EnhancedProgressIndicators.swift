...
struct ProgressIndicatorView: View {
    ...
    init(progress: Double, total: Double = 1.0, title: String, subtitle: String? = nil, style: ProgressStyle = .detailed) {
...
struct AnalysisProgressCard: View {
    ...
    enum AnalysisStage {
        ...
        var title: String {
            ...
            case .finalizing: return "Preparing Results"
            }
        }
...
struct MultiStepProgressIndicator: View {
    ...
    var body: some View {
        VStack(spacing: 16) {
            // Step indicators
            HStack {
                ForEach(Array(steps.enumerated()), id: \.offset) { [weak self] index, step in
                    HStack {
                        Circle()
...
struct SmartLoadingView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            HStack(spacing: 8) {
                ForEach(0..<3) { [weak self] index in
                    Circle()
